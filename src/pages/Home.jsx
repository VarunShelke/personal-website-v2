  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Varun Shelke is a software engineer who specializes in building exceptional digital experiences. Currently working at AWS Cloud Innovation Center." />
        <meta name="keywords" content="Varun Shelke, software engineer, web developer, javascript, python, react, aws, backend developer" />
        <meta name="author" content="Varun Shelke" />
        
        {/* Enhanced Open Graph */}
        <meta property="og:title" content="Varun Shelke - Software Engineer" />
        <meta property="og:description" content="Software engineer specializing in building exceptional digital experiences with modern web technologies and cloud platforms." />
        ...
        <meta name="twitter:description" content="Software engineer specializing in building exceptional digital experiences with modern web technologies and cloud platforms." />
